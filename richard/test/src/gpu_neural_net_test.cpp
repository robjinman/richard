...
TEST_F(GpuNeuralNetTest, simpleDenseNetwork) {
  ...
  Config layer1Config;
  layer1Config.setInteger("size", layer1Size);
  layer1Config.setFloat("learnRate", 0.1);
  layer1Config.setFloat("learnRateDecay", 1.0);
  layer1Config.setFloat("dropoutRate", 0.0);

  Config layer2Config;
  layer2Config.setInteger("size", layer2Size);
  layer2Config.setFloat("learnRate", 0.1);
  layer2Config.setFloat("learnRateDecay", 1.0);
...
TEST_F(GpuNeuralNetTest, simpleConvNetwork) {
  ...
  Config layer1Config;
  layer1Config.setInteger("depth", 2);
  layer1Config.setIntegerArray<size_t>("kernelSize", { 2, 2 });
  layer1Config.setFloat("learnRate", 0.1);
  layer1Config.setFloat("learnRateDecay", 1.0);
  layer1Config.setFloat("dropoutRate", 0.0);

  Config layer2Config;
  layer2Config.setIntegerArray<size_t>("regionSize", { 2, 2 });

  Config layer3Config;
  layer3Config.setInteger("size", 2);
  layer3Config.setFloat("learnRate", 0.1);
  layer3Config.setFloat("learnRateDecay", 1.0);
